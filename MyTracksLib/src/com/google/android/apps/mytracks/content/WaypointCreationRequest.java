...
public class WaypointCreationRequest implements Parcelable {
  ...
  public WaypointCreationRequest(WaypointType type,String name,String description, String iconUrl){
    this(type, false, name, null, description, iconUrl);
  }
