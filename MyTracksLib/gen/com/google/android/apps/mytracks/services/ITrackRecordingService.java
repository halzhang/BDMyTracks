 ...
 * Original file: E:\\open\\BDMyTracks\\MyTracksLib\\src\\com\\google\\android\\apps\\mytracks\\services\\ITrackRecordingService.aidl
 */
...
static final int TRANSACTION_isPaused = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
...
static final int TRANSACTION_pauseCurrentTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_resumeCurrentTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_endCurrentTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getSensorData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getSensorState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
/**
   * Starts recording a new track.
   *
