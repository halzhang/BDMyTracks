...
public class TrackListActivity extends FragmentActivity implements DeleteOneTrackCaller {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menu.findItem(R.id.track_list_save_all_txt)
        .setTitle(getString(R.string.menu_save_format, fileTypes[4]));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
      ...
      case R.id.track_list_save_all_tcx:
        ...
        return true;
      case R.id.track_list_save_all_txt:
        startSaveActivity(TrackFileFormat.TXT);
        return true;
